...
% Aber auch bei der Datenübertragung sind Fehlinterpretationen möglich
% Kontext wird nicht einbezogen
% -> Impuls vs Interesse unklar 
% -> Hausparty oder Recherche unklar
% -> Mehrere Leute nutzen ein Gerät
...
% Bestätigungsfehler Psychologie
% Schemata: Assimilation und Akkommodation
% Nicht nur mit Objekten, sondern auch mit Meinungen
% Wieso machen wir das? -> Damit wir nicht immer alles neu lernen müssen

% Serendipity (Glücklicher Zufall)
% Statistischer Ausschluss von Outlier
% -> Diese machen das Leben interessant
% -> Schenken kleinen Stimmen keine Aufmerksamkeit
% Information gap (Neugier entsteht, wenn Wissen fehlt)
% -> Muss bewusst sein, dass Wissen fehlt, RS versteckt das aber

% Altruismus wichtig, aber RS schiebt uns Richtung Egoismus
% -> Postmaterialismus?
...
% Identität formt Medien -> Aber Rückrichtung ebenfalls und das passiert unbewusst
