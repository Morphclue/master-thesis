...
Bis zum Ende des 18. Jahrhunderts waren die meisten Zeitungen nicht für die breite Masse der Bevölkerung gedacht, sondern für eine kleine, privilegierte Gruppe.
...
Das lag daran, dass sich der Inhalt dieser Zeitungen nun auch an Arbeiter und Immigranten richtete.
...
Eine Vielzahl von Gründen trägt zu dieser Präferenz bei.
Der bedeutendste Faktor ist die Fähigkeit von \acp{RS}, Empfehlungen auf individueller Basis anzupassen.
...
Kuratierte Empfehlungen hingegen sind für eine breite Masse ausgelegt und können nicht auf individueller Ebene angepasst werden.
Zusätzlich passen sich \acp{RS} schnell an das ändernde Verhalten von Nutzenden an.
Neue Inhalte können somit schneller in die Empfehlungen von \acp{RS} integriert werden.
