...
%%%% Ökomie der Konventionen - Knoll
% 6 Welten aus "Über die Rechtfertigung"
% 1. Welt: Inspiration - unkonventionelle Leidenschaft, die nicht durch Leistung erreicht werden kann
% 2. Welt: Hauses - Tradition 
% 3. Welt: Markt - Konkurrenz
% 4. Welt: Meinung - Wertvoll wer am meisten "Follower" hat
% 5. Welt: Bürgertum - Repräsentation einer Gruppe
% 6. Welt: Industrie - Zukunftsorientiert, effizient und produktiv
% Annahme: Pluralität von Bewertungsmaßstäben
% Das Vorgegebene kann auch immer anders interpretiert werden -> ergo kritisiert werden
% Welten bestehen aus Mischformen (Kompromisse)
% Strukturen als Ergebnis von Rechtfertigungsprozessen
% Kritik -> Zwang zur Rechtfertigung -> Veränderung
% Kritik kann bestärken oder schwächen
% Struktur ist das Spiegelbild der Kritik

%%%% Mapping of controversies - Solans + Laser Ochs
